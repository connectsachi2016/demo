...
with DAG(
  ...
  with TaskGroup("AUM_Int_Models",tooltip = "Task Group for AUM Int") as int_grp:  
    ...
    with TaskGroup("AUM_Int_Container",tooltip = "Task Group for AUM Int") as AUM_Container_grp:  
      ...
      Some_Parallel_Tsk_1 = EmptyOperator(task_id = "Some_Parallel_Tsk_1" , bash_command = 'echo "Some_Parallel_Tsk_1"' )
            
      Some_Parallel_Tsk_2 = EmptyOperator(task_id = "Some_Parallel_Tsk_2" , bash_command = 'echo "Some_Parallel_Tsk_2"' )

      #parallel_flows(Some_Parallel_Tsk_1 ,Some_Parallel_Tsk_2 )    
